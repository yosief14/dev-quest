    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className="sm:max-w-md space-y-5">
                <DialogHeader>
                    <DialogTitle className="text-xl mb-5">Autofill the form</DialogTitle>
                    <DialogDescription className="text-base text-black">
                        Paste a link to the job post
                    </DialogDescription>
                </DialogHeader>
                <FormConponent />
                <DialogFooter className="sm:justify-between ">
                    <DialogClose asChild>
                        <button className="text-base self-start  sm:self-center p-[3px] relative">
                            <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg" />
                            <div className="px-8 py-2  bg-black rounded-[6px]  relative group transition duration-200 text-white hover:bg-transparent">
                                Close
                            </div>
